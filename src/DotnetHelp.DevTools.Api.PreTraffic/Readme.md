...
Execute unit tests
```
    cd "DotnetHelp.DevTools.Api.PreTraffic/test/DotnetHelp.DevTools.Api.PreTraffic.Tests"
    dotnet test
```

Deploy function to AWS Lambda
```
    cd "DotnetHelp.DevTools.Api.PreTraffic/src/DotnetHelp.DevTools.Api.PreTraffic"
